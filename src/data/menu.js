export const restaurantName = 'مطبخ ماسه'
export const tagline = '✨معانا حتدووق طعم النظافه ✨'
export const phone = '+201223831783'
...
export const whatsappLink = `https://wa.me/201223831783?text=${encodeURIComponent('السلام عليكم، أريد الطلب من مطبخ ماسه')}`
...
export const categories = [
  {
    ...
    items: [
      // رز
      { name: 'رز بالشعرية (الكيلو)', price: 130, image: '/images/products/رز-بالشعريه-130.jpg' },
      // بانيه
      { name: 'نص بانيه', price: 190, image: '/images/products/نص-بانيه-190.png' },
      // مخللات
      { name: 'كيلو باذنجان مخلل', price: 80, image: '/images/products/كيلو-باذنجان-مخلل-80.png' },
      // حواوشي
      { name: 'حواوشي لحمة بلدي (الرغيف)', price: 50, image: '/images/products/حواوشى-لحمه-بلدى-50.png' },
      // كباب
      { name: 'كباب حلة (الكيلو)', price: 600, image: '/images/products/كباب-حله-600.jpg' },
      // محاشي
  ...
  },
  {
    ...
    items: [
      { name: 'كبسة بالديك الرومي', price: 500, image: '/images/products/كبسه-بالديك-الرومى-500.png' },
      ...
      { name: 'باكدج 1100: بطه جامبو، نص ممبار، نص كفتة، كيلو رز بسمتي، بطاطس محمرة', price: 1100, image: '/images/products/1100بطه-جامبو-نص-ممبار-نص-كفته-كيلو-رز-بسمتي-بطاطس-محمره.jpg' },
      ...
      { name: 'ديك رومي ~7 كيلو مع رز بسمتي', price: 1750, image: '/images/products/1500-ديك-رومي-8كيلو-تقريبا-مع-رز-بسمتى.jpg' },
